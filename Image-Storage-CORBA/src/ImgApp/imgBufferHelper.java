...
/**
* ImgApp/imgBufferHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from StoreImg.idl
* Wednesday, April 25, 2018 1:37:38 PM EET
*/

abstract public class imgBufferHelper
{
  private static String  _id = "IDL:ImgApp/imgBuffer:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ImgApp.imgBufferHelper.id (), "imgBuffer", __typeCode);
    }
    return __typeCode;
  }
